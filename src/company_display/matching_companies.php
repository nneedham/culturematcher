...
<html lang="en">
  <!-- include header -->
  <head>
    <title>Culture Matcher - Matching Companies</title>
    <meta name="description" content="This page contains the list of companies that match your culture">
        ...
        <div class="row align-items-center">
          <div class="col">
            ...
            <p class="font-size-lg text-white-75 mb-0">
              Let's see which companies you best fit with.
            </p>
      ...
      <div class="container-md">
        <div class="card shadow-light-lg accordion mb-5 mb-md-6" id="helpAccordionOne">
          <div class="list-group">
            ...
            <?php
              if ($company_table_created){
                require "./pages/matchingcompanies/sql_matching_companies.php";
              } else {
                require "./pages/matchingcompanies/curl_matching_companies.php";
              }
